...
export const loadImageBitmaps = (factory, n) => __awaiter(void 0, void 0, void 0, function* () {
    return yield Promise.all(ArrayUtils.fill(n, factory)
...
export class Hold {
    ...
    static forAnimation(animate, numFrames) {
        let frame = 0;
        return new Promise(resolve => {
            const run = () => {
                if (++frame <= numFrames) {
